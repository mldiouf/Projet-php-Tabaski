...
<nav class="navbar navbar-expand-lg navbar-light bg-light text-primary">
  <div class="container-fluid bg-light text-primary">
    ...
    <div class="collapse navbar-collapse text-dark" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="listeMembre.php" style="text-decoration:none; "><h5>LISTE MEMBRE</h5></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="listeCotisation.php" style="text-decoration:none;"><h5>LISTE COTISATION</h5></a>
        </li>
        <li class="nav-item">
